...
@section('title','Meeyaar | Shipping | Current Complains')
@push('plugin-styles')
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <a href="{{route('admin.shipping_management.complains.current.resolved',$complain->id)}}" role="button" class="btn btn-primary">Resolved</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
        ...
        <div class="modal-dialog modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header bg-primary">
              <h5 class="modal-title" id="exampleModalLongTitle">Complain Order</h5>
...
<script>
    $(document).ready(function()
    {
        $('.complain').on('click',function()
        {
            ...
            $('.modal-body').append('<input type="hidden" value="'+id+'">');
