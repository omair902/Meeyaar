<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
    <a class="navbar-brand brand-logo" href="{{ url('/') }}">
      <h3 class="text-dark">Meeyaar</h3>
      {{-- <img src="{{ url('admin/images/ranz.png') }}" alt="logo"/>  --}}
    </a>
    <a class="navbar-brand brand-logo-mini" href="{{ url('/') }}">
      <h5 class="text-dark">Meeyaar</h5>
      {{-- <img src="{{ url('admin/images/ranz.png') }}" alt="logo" /> --}}
     </a>
  </div>
    ...
    <ul class="navbar-nav navbar-nav-right">
      <!-- <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
          ...
          <a class="dropdown-item preview-item">
            <div class="preview-thumbnail">
              <img src="{{ asset('admin/assets/images/faces/face3.jpg') }}" alt="image" class="img-sm profile-pic"> </div>
            <div class="preview-item-content flex-grow py-2">
      ...
      <li class="nav-item dropdown d-none d-xl-inline-block">
        <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
          ...
          <img class="img-xs rounded-circle" src="{{ asset('admin/assets/images/faces/face1.jpg') }}" alt="Profile image"> </a>
